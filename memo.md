    ...
    Select Case baseType
        ...
        Case "VARCHAR"
            ...
            If openPos > 0 And closePos > openPos Then
                ...
                paramText = Mid$(dt, openPos + 1, closePos - openPos - 1)
        ...
        Case "NUMBER"
            ...
            If IsStrictNumber(valueText) = False Then
                errMsg = "数値を入力してください。"
                Exit Function
            End If
            ...
            If precision > 0 Then
                ...
                numberText = Trim$(valueText)

                If Left$(numberText, 1) = "+" _
                   Or Left$(numberText, 1) = "-" Then
                ...
                Do While Len(integerPart) > 1 _
                      And Left$(integerPart, 1) = "0"
                ...
                If integerDigits > maxIntegerDigits Then
                    errMsg = _
                        "整数部は" & CStr(maxIntegerDigits) & _
                        "桁以内で入力してください。"
                    Exit Function
                End If

                If integerDigits + decimalDigits > precision Then
                    errMsg = _
                        "全体は" & CStr(precision) & _
                        "桁以内で入力してください。"
                    Exit Function
                End If
        ...
        Case Else
            ...
            errMsg = _
                "現在のマクロはVARCHARとNUMBERのみ対応しています。" & _
                "（定義：" & dataTypeRaw & "）"
            Exit Function
...
'   1.2.3
'==========================================================
Private Function IsStrictNumber(ByVal valueText As String) As Boolean
